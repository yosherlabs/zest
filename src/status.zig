...
test "invalid values return an error" {
    ...
    try expect_error(expected_error, parse(" "));
    try expect_error(expected_error, parse("99"));
    try expect_error(expected_error, code(99));
}

test "status code 100" {
    const status = Status.@"continue";
    try expect(std.mem.eql(u8, status.to_string(), "100"));
    try expect(status.to_u16() == 100);
...
test "status code 101" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "101"));
    try expect(status.to_u16() == 101);
...
test "status code 200" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "200"));
    try expect(status.to_u16() == 200);
...
test "status code 201" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "201"));
    try expect(status.to_u16() == 201);
...
test "status code 202" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "202"));
    try expect(status.to_u16() == 202);
...
test "status code 203" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "203"));
    try expect(status.to_u16() == 203);
...
test "status code 204" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "204"));
    try expect(status.to_u16() == 204);
...
test "status code 205" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "205"));
    try expect(status.to_u16() == 205);
...
test "status code 206" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "206"));
    try expect(status.to_u16() == 206);
...
test "status code 300" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "300"));
    try expect(status.to_u16() == 300);
...
test "status code 301" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "301"));
    try expect(status.to_u16() == 301);
...
test "status code 302" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "302"));
    try expect(status.to_u16() == 302);
...
test "status code 303" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "303"));
    try expect(status.to_u16() == 303);
...
test "status code 304" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "304"));
    try expect(status.to_u16() == 304);
...
test "status code 307" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "307"));
    try expect(status.to_u16() == 307);
...
test "status code 308" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "308"));
    try expect(status.to_u16() == 308);
...
test "status code 400" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "400"));
    try expect(status.to_u16() == 400);
...
test "status code 401" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "401"));
    try expect(status.to_u16() == 401);
...
test "status code 403" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "403"));
    try expect(status.to_u16() == 403);
...
test "status code 404" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "404"));
    try expect(status.to_u16() == 404);
...
test "status code 405" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "405"));
    try expect(status.to_u16() == 405);
...
test "status code 406" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "406"));
    try expect(status.to_u16() == 406);
...
test "status code 407" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "407"));
    try expect(status.to_u16() == 407);
...
test "status code 408" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "408"));
    try expect(status.to_u16() == 408);
...
test "status code 409" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "409"));
    try expect(status.to_u16() == 409);
...
test "status code 410" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "410"));
    try expect(status.to_u16() == 410);
...
test "status code 411" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "411"));
    try expect(status.to_u16() == 411);
...
test "status code 412" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "412"));
    try expect(status.to_u16() == 412);
...
test "status code 413" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "413"));
    try expect(status.to_u16() == 413);
...
test "status code 414" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "414"));
    try expect(status.to_u16() == 414);
...
test "status code 415" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "415"));
    try expect(status.to_u16() == 415);
...
test "status code 416" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "416"));
    try expect(status.to_u16() == 416);
...
test "status code 417" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "417"));
    try expect(status.to_u16() == 417);
...
test "status code 421" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "421"));
    try expect(status.to_u16() == 421);
...
test "status code 422" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "422"));
    try expect(status.to_u16() == 422);
...
test "status code 426" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "426"));
    try expect(status.to_u16() == 426);
...
test "status code 500" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "500"));
    try expect(status.to_u16() == 500);
...
test "status code 501" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "501"));
    try expect(status.to_u16() == 501);
...
test "status code 502" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "502"));
    try expect(status.to_u16() == 502);
...
test "status code 503" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "503"));
    try expect(status.to_u16() == 503);
...
test "status code 504" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "504"));
    try expect(status.to_u16() == 504);
...
test "status code 505" {
    ...
    try expect(std.mem.eql(u8, status.to_string(), "505"));
    try expect(status.to_u16() == 505);
